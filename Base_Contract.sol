...
contract YLYZ is ERC721Enumerable, Ownable {
    using Strings for uint256;

    // This NFT contract has a function setSaleIsActive, which you can call to activate and deactivate the sale.
    ...
    constructor(string memory initBaseURI, string memory initNotRevealedUri) ERC721("TEST TOKEN", "YZ") {
